...
def upgrade():
    ...
    op.create_table('class_translation',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('class_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('locale', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['class_id'], ['class.uuid'], name=op.f('fk_class_translation_class_id_class')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_class_translation')),
    sa.UniqueConstraint('id', name=op.f('uq_class_translation_id'))
    )
    op.create_index(op.f('ix_class_translation_class_id'), 'class_translation', ['class_id'], unique=False)
    op.create_table('spell_variant_pair',
    sa.Column('uuid', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('class_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['class_id'], ['class.uuid'], name=op.f('fk_spell_variant_pair_class_id_class')),
    ...
    sa.Column('uuid', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('spell_variant_pair_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('image_url', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['spell_variant_pair_id'], ['spell_variant_pair.uuid'], name=op.f('fk_spell_spell_variant_pair_id_spell_variant_pair')),
    sa.PrimaryKeyConstraint('uuid', name=op.f('pk_spell')),
    sa.UniqueConstraint('uuid', name=op.f('uq_spell_uuid'))
    )
    op.create_index(op.f('ix_spell_spell_variant_pair_id'), 'spell', ['spell_variant_pair_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['spell_id'], ['spell.uuid'], name=op.f('fk_spell_stats_spell_id_spell')),
    sa.PrimaryKeyConstraint('uuid', name=op.f('pk_spell_stats'))
    )
    op.create_table('spell_translation',
    sa.Column('uuid', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('spell_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('locale', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['spell_id'], ['spell.uuid'], name=op.f('fk_spell_translation_spell_id_spell'), ondelete='CASCADE'),
    ...
    sa.Column('effect_type', sa.Enum('NEUTRAL_DAMAGE', 'EARTH_DAMAGE', 'FIRE_DAMAGE', 'WATER_DAMAGE', 'AIR_DAMAGE', 'NEUTRAL_STEAL', 'EARTH_STEAL', 'FIRE_STEAL', 'WATER_STEAL', 'AIR_STEAL', 'AP', 'MP', 'HP_RESTORED', 'SHIELD', 'PUSHBACK_DAMAGE', name='spelleffecttypes'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['spell_stat_id'], ['spell_stats.uuid'], name=op.f('fk_spell_effect_spell_stat_id_spell_stats')),
    sa.PrimaryKeyConstraint('uuid', name=op.f('pk_spell_effect'))
    )
    op.create_table('spell_stat_translation',
    sa.Column('uuid', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('spell_stat_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('locale', sa.String(), nullable=False),
    sa.Column('aoe_type', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['spell_stat_id'], ['spell_stats.uuid'], name=op.f('fk_spell_stat_translation_spell_stat_id_spell_stats'), ondelete='CASCADE'),
