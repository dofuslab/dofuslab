...
PROD_LEVEL_SAMPLE_TARGETS = (
    ...
    # Prod shape requires an MP exo under current v0 assumptions; tier 1/no-exo did not generate.
...
AP_MP_RANGE_GRID_NEXT_CAP_2_TARGETS = (
    LevelDiversityTarget("grid_next_cap2_level_1_intelligence_12_6_6_budget4", 1, "intelligence", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_20_chance_12_6_6_budget4", 20, "chance", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_50_agility_12_6_6_budget4", 50, "agility", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_80_strength_12_6_6_budget3", 80, "strength", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_99_intelligence_12_6_6_budget4", 99, "intelligence", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_100_chance_12_6_6_budget4", 100, "chance", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_120_agility_12_6_6_budget4", 120, "agility", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_150_strength_12_6_6_budget3", 150, "strength", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_179_intelligence_12_6_6_budget4", 179, "intelligence", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_180_chance_12_6_6_budget4", 180, "chance", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_199_agility_12_6_6_budget4", 199, "agility", 4, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap2_level_200_strength_12_6_6_budget3", 200, "strength", 3, 12, 6, 6),
)

AP_MP_RANGE_GRID_NEXT_CAP_3_TARGETS = (
    LevelDiversityTarget("grid_next_cap3_level_1_intelligence_12_6_6_budget3", 1, "intelligence", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_20_chance_12_6_6_budget3", 20, "chance", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_50_agility_12_6_6_budget3", 50, "agility", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_80_strength_12_6_6_budget2", 80, "strength", 2, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_99_intelligence_12_6_6_budget3", 99, "intelligence", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_100_chance_12_6_6_budget3", 100, "chance", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_120_agility_12_6_6_budget3", 120, "agility", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_150_strength_12_6_6_budget2", 150, "strength", 2, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_179_intelligence_12_6_6_budget3", 179, "intelligence", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_180_chance_12_6_6_budget3", 180, "chance", 3, 12, 6, 6),
    LevelDiversityTarget("grid_next_cap3_level_199_agility_12_6_6_budget3", 199, "agility", 3, 12, 6, 6),
