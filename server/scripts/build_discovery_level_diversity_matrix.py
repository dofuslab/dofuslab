...
def main() -> None:
    ...
    parser.add_argument(
        "--target-set",
        choices=("level-diversity", "boundary", "coverage", "grid-next-minimum", "grid-next-minimum-2", "grid-next-minimum-3", "grid-next-cap", "grid-next-cap-2", "all"),
