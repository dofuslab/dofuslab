...
|---|---|---|---|---|---|---|
| L1 strength 12/6/6 tier 4 | no_build | item_stat_upper_bound_below_target | 7/4/1 | not found |  | AP optimistic upper bound 7 is below target 12; MP optimistic upper bound 4 is below target 6; Range optimistic upper bound 1 is below target 6 |
| L20 strength 12/6/6 tier 4 | no_build | item_stat_upper_bound_below_target | 10/6/4 | not found, state cap hit |  | AP optimistic upper bound 10 is below target 12; Range optimistic upper bound 4 is below target 6 |
